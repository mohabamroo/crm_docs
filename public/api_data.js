define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "won",
            "description": "<p>Optional param [1 for won leads &amp; 0 for lost leads]</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "POST",
    "url": "/lists/bulk-delete",
    "title": "Delete Multiple Lists",
    "name": "DeleteMultipleLists",
    "group": "ListsController",
    "version": "0.1.0",
    "parameter": {
      "examples": [
    ...
    "success": {
      "examples": [
        {
          "title": "success-Response:",
          "content": "HTTP/1.1 200\n{\n  \"errors\": [],\n  \"msg\": \"Successfully deleted the requested lists\"\n}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "mail/config-info",
    "title": "Read mail settings",
    "name": "ReadMailSettings",
    "group": "MailFetching",
    "version": "0.1.0",
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "    HTTP/1.1 201 created\n{\n  \"PaymentMethod\": {\n      \"id\": \"43\",\n      \"title\": \"test6\",\n      \"is_actual\": null,\n      \"is_visible\": true,\n      \"is_external\": null\n  },\n  \"msg\": \"Successfully created the requested payment method\"\n}",
          "type": "json"
        }
      ]
    },
    "error": {
      "examples": [
        {
          "title": "Error-Response:",
          "content": "  HTTP/1.1 400 Bad Request\n  {\n  \"msg\": \"Failed to create the requested payment method\",\n  \"errors\": {\n      \"title\": [\n          \"The payment method title must remain unique\"\n      ]\n  }\n}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Mandatory Payment Method id</p>"
          }
        ]
      }
    },
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "   HTTP/1.1 200 OK\n{\n \"msg\": \"Successfully deleted the requested payment method!\"\n}",
          "type": "json"
        }
      ],
      "fields": {
  ...
  {
    "type": "get",
    "url": "/payments/logs/:request_id",
    "title": "Request Payments Logs",
    "name": "RequestPaymentsLogs",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": " HTTP/1.1 200 OK\n  {\n   \"logs\": [\n        {\n          \"RequestPayment\": {\n              \"id\": \"2\",\n              \"payment_method_id\": \"3\",\n              \"payment_amount\": \"250.00\",\n              \"payment_date\": \"2009-11-03\",\n              \"request_id\": \"332409\",\n              \"attachment_file\": \"/attachments/payment_evidence/30/12572396223d-cars-3.jpg\",\n              \"currency_id\": \"3\",\n              \"created\": \"2009-11-03 11:13:42\",\n              \"conversion_rate\": \"1.0000\",\n              \"added_by\": null,\n              \"visa_card_no\": null,\n              \"visa_exp_date\": null,\n              \"approved\": null,\n              \"is_option\": \"0\",\n              \"external_agency_id\": null,\n              \"notes\": null,\n              \"scheduled_payment_id\": null\n          },\n          \"AddedBy\": {\n              \"name\": null\n          },\n          \"PaymentMethod\": {\n              \"id\": \"3\",\n              \"title\": \"Western Union\"\n          },\n          \"Currency\": {\n              \"id\": \"3\",\n              \"abbrev\": \"EGP\",\n              \"symbol\": \"L.E.\"\n          }\n      }\n  ]\n}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Mandatory methodId</p>"
          }
        ]
      },
      "examples": [
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "    HTTP/1.1 200 OK\n{\n  \"PaymentMethod\": {\n      \"id\": \"43\",\n      \"title\": \"test6\",\n      \"is_actual\": null,\n      \"is_visible\": true,\n      \"is_external\": null\n  },\n  \"msg\": \"Successfully updated the requested payment method\"\n}",
          "type": "json"
        }
      ]
    },
    "error": {
      "examples": [
        {
          "title": "Error-Response:",
          "content": "  HTTP/1.1 400 Bad Request\n  {\n  \"msg\": Failed to update the requested payment method\",\n  \"errors\": {\n      \"title\": [\n          \"The payment method title must remain unique\"\n      ]\n  }\n}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "success": {
      "examples": [
        {
          "title": "success-Response:",
          "content": "   HTTP/1.1 200\n{\n \"msg\": \"Successfully updated the requested password\"\n}",
          "type": "json"
        }
      ]
    },
    "error": {
      "examples": [
        {
          "title": "Error-Response:",
          "content": " HTTP/1.1 400 Bad Request\n{\n\"msg\": \"Old Password didn't match our records\"\n}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "put",
    "url": "/users/new-password/:code/:user_id",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "code",
            "description": "<p>Mandatory Sent Mail code</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
  ...
  },
  {
    ...
    "success": {
      "examples": [
        {
          "title": "success-Response:",
          "content": "HTTP/1.1 200\n{\n\t \"Staff\": {\n\t \n\t     \"email\":\"ayman.badry@deemalab.com\"\n\t }\n}",
          "type": "json"
        },
        {
          "title": "Success-Response:",
    ...
    "error": {
      "examples": [
        {
          "title": "Error-Response:",
          "content": "HTTP/1.1 404 Not Found\n{\n    \"msg\": \"No user was found with the submitted email address.\"\n}",
          "type": "json"
        }
      ]
    },
