define({ "api": [
  ...
  },
  {
    ...
    "success": {
      "examples": [
        ...
        {
          "title": "Error-Response:",
          "content": "{\n   \"msg\": \"Organization Unsuccessfully updated\",\n   \"errors\": {\n      \"notes\": [\n             \"The Note body is required\"\n       ]\n     }\n   }",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "/permissions/job-title/:job_title_id",
  ...
  },
  {
    ...
    "group": "SysConfigs",
    "description": "<p>name key could be &quot;timezone, currency,&quot;</p>",
    "version": "0.1.0",
    "parameter": {
      "examples": [
        {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "my_users",
            "description": "<p>Optional Query Param for List department users only</p>"
          }
        ]
      }
    },
    "description": "<p>by passing 1 to my_users query param you will get the requested department users only.</p>",
    "group": "Users",
    "version": "0.1.0",
    "success": {
      "examples": [
